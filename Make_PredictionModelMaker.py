...
if __name__ == '__main__':
    ...
    classes_vocab = SimpleVocabulary(
        save_path='./snips/make_classes.dict',
        load_path='./snips/make_classes.dict')
    ...
    token_vocab = SimpleVocabulary(
        save_path='./snips/make_tokens.dict',
        load_path='./snips/make_tokens.dict',
        min_freq=2,
    ...
    tfidf = SklearnComponent(
        ...
        save_path='./make_tfidf_v0.pkl',
        load_path='./make_tfidf_v0.pkl',
        mode='train')
    ...
    cls = SklearnComponent(
        ...
        save_path='./make_logreg_v0.pkl',
        load_path='./make_logreg_v0.pkl',
        C=1,
        mode='train')
