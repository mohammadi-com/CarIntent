...
if __name__ == '__main__':
    ...
    classes_vocab = SimpleVocabulary(
        save_path='./snips/model_classes.dict',
        load_path='./snips/model_classes.dict')
    ...
    token_vocab = SimpleVocabulary(
        save_path='./snips/model_tokens.dict',
        load_path='./snips/model_tokens.dict',
        min_freq=2,
    ...
    tfidf = SklearnComponent(
        ...
        save_path='./model_tfidf_v0.pkl',
        load_path='./model_tfidf_v0.pkl',
        mode='train')
    ...
    cls = SklearnComponent(
        ...
        save_path='./model_logreg_v0.pkl',
        load_path='./model_logreg_v0.pkl',
        C=1,
        mode='train')
